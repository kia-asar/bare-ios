...
public enum AppConfig {
    ...
    public static let appGroupIdentifier = "group.co.bareapp.bare"
    ...
    public static let keychainAccessGroupSuffix = "co.bareapp.bare.sharedkeychain"
    
    // MARK: - URL Scheme
    
    /// Custom URL scheme for deep linking
    /// Must match: `CFBundleURLSchemes` in Info.plist
    public static let urlScheme = "bareapp"
    ...
    public static let mainAppBundleID = "co.bareapp.bare"
    ...
    public static let shareExtensionErrorDomain = "com.bareapp.shareextension"
}
