...
#Preview("Soft Kill Switch") {
    Text("Main Content")
        .softKillSwitchAlert(message: "A new version of Bare is available. Please update for the best experience.")
}

#Preview("Hard Kill Switch") {
    HardKillSwitchView(message: "This version of Bare is no longer supported. Please update to continue using the app.")
}
